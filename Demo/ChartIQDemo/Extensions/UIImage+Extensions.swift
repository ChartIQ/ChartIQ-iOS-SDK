...
extension UIImage {
  ...
  struct Chart {
    ...
    internal static let drawToolActiveImage = UIImage(named: "iconDrawFocused")
  ...
  struct ChartIQDrawingTool {
    ...
    internal static let checkImage = UIImage(named: "drawingToolCheckIcon")
    internal static let continuousImage = UIImage(named: "drawingToolContinuousLineIcon")
    internal static let crossImage = UIImage(named: "drawingToolCrossIcon")
    ...
    internal static let focusImage = UIImage(named: "drawingToolFocusIcon")
    ...
    internal static let heartImage = UIImage(named: "drawingToolHeartIcon")
    ...
    internal static let segmentImage = UIImage(named: "drawingToolSegmentIcon")
    ...
    internal static let starImage = UIImage(named: "drawingToolStarIcon")
