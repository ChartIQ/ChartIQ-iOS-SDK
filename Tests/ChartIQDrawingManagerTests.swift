...
class ChartIQDrawingManagerTests: XCTestCase {
  ...
  func testsChartIQDrawingManagerisToolSupportingStdDeviations() {
    ...
    // When // Then
    XCTAssertEqual(annotation, chartIQDrawingManager.isSupportingStdDeviations(.annotation))
    XCTAssertEqual(arrow, chartIQDrawingManager.isSupportingStdDeviations(.arrow))
    XCTAssertEqual(average, chartIQDrawingManager.isSupportingStdDeviations(.average))
    XCTAssertEqual(callout, chartIQDrawingManager.isSupportingStdDeviations(.callout))
    XCTAssertEqual(channel, chartIQDrawingManager.isSupportingStdDeviations(.channel))
    XCTAssertEqual(check, chartIQDrawingManager.isSupportingStdDeviations(.check))
    XCTAssertEqual(continuous, chartIQDrawingManager.isSupportingStdDeviations(.continuous))
    XCTAssertEqual(cross, chartIQDrawingManager.isSupportingStdDeviations(.cross))
    XCTAssertEqual(crossline, chartIQDrawingManager.isSupportingStdDeviations(.crossline))
    XCTAssertEqual(doodle, chartIQDrawingManager.isSupportingStdDeviations(.doodle))
    XCTAssertEqual(elliottWave, chartIQDrawingManager.isSupportingStdDeviations(.elliottWave))
    XCTAssertEqual(ellipse, chartIQDrawingManager.isSupportingStdDeviations(.ellipse))
    XCTAssertEqual(fibArc, chartIQDrawingManager.isSupportingStdDeviations(.fibArc))
    XCTAssertEqual(fibFan, chartIQDrawingManager.isSupportingStdDeviations(.fibFan))
    XCTAssertEqual(fibProjection, chartIQDrawingManager.isSupportingStdDeviations(.fibProjection))
    XCTAssertEqual(fibRetracement, chartIQDrawingManager.isSupportingStdDeviations(.fibRetracement))
    XCTAssertEqual(fibTimeZone, chartIQDrawingManager.isSupportingStdDeviations(.fibTimeZone))
    XCTAssertEqual(focus, chartIQDrawingManager.isSupportingStdDeviations(.focus))
    XCTAssertEqual(gannFan, chartIQDrawingManager.isSupportingStdDeviations(.gannFan))
    XCTAssertEqual(gartley, chartIQDrawingManager.isSupportingStdDeviations(.gartley))
    XCTAssertEqual(heart, chartIQDrawingManager.isSupportingStdDeviations(.heart))
    XCTAssertEqual(horizontal, chartIQDrawingManager.isSupportingStdDeviations(.horizontal))
    XCTAssertEqual(line, chartIQDrawingManager.isSupportingStdDeviations(.line))
    XCTAssertEqual(pitchfork, chartIQDrawingManager.isSupportingStdDeviations(.pitchfork))
    XCTAssertEqual(quadrantLines, chartIQDrawingManager.isSupportingStdDeviations(.quadrantLines))
    XCTAssertEqual(ray, chartIQDrawingManager.isSupportingStdDeviations(.ray))
    XCTAssertEqual(rectangle, chartIQDrawingManager.isSupportingStdDeviations(.rectangle))
    XCTAssertEqual(regression, chartIQDrawingManager.isSupportingStdDeviations(.regression))
    XCTAssertEqual(segment, chartIQDrawingManager.isSupportingStdDeviations(.segment))
    XCTAssertEqual(speedResistanceArc, chartIQDrawingManager.isSupportingStdDeviations(.speedResistanceArc))
    XCTAssertEqual(speedResistanceLine, chartIQDrawingManager.isSupportingStdDeviations(.speedResistanceLine))
    XCTAssertEqual(star, chartIQDrawingManager.isSupportingStdDeviations(.star))
    XCTAssertEqual(timeCycle, chartIQDrawingManager.isSupportingStdDeviations(.timeCycle))
    XCTAssertEqual(tironeLevels, chartIQDrawingManager.isSupportingStdDeviations(.tironeLevels))
    XCTAssertEqual(trend, chartIQDrawingManager.isSupportingStdDeviations(.trend))
    XCTAssertEqual(vertical, chartIQDrawingManager.isSupportingStdDeviations(.vertical))
    XCTAssertEqual(noTool, chartIQDrawingManager.isSupportingStdDeviations(.noTool))
    XCTAssertEqual(measure, chartIQDrawingManager.isSupportingStdDeviations(.measure))
  }
